<template>
    <section>
        <div class="page-title">
            ...
            <div>
                <el-button @click="handleAdd" type="text" size="medium" :icon="!isEdit?'el-icon-plus':'el-icon-close'">{{!isEdit?'新增仓库库位':'取消返回'}}</el-button>
            </div>
        </div>
        <div class="grid-container" v-if="!isEdit">
            ...
            style="width: 100%">
                ...
                <el-table-column prop="name" label="库位名称" width="200px"></el-table-column>
