  ...
  <section>
    ...
    <div class="grid-container">
        <div class="search-content">
            ...
            <el-form-item label="业务类型：" prop="typeId">
                ...
                placeholder="请选择"
                style="width:100px"
                v-if="setting" clearable="" @change="submitSearch"
                >
                <el-option
                ...
                <el-table-column prop="incount" label="未来10天内采购量">
                    <template slot-scope="scope">
                        <span :class="{'warning':scope.row.incount==0}">
                            ...
                            <!-- <el-button
                            type="text"
                            v-if="parseMaterialNo(scope.row)<0"
                            @click="viewAfterOrder(scope.row)"
                            >查阅</el-button> -->
                        </span>
                    </template>
                </el-table-column>
    ...
    <el-dialog title="比较采购订单" append-to-body :visible.sync="openDialogVisible" width="60%">
      <div style="margin-top:-10px" v-if="afterOrderItem">
        ...
        >供应商：{{afterOrderItem.crmName}}；采购货品：{{afterOrderItem.productName}}</div>
    ...
    methods: {
        ...
        async getBuys() {
            ...
            let params = {
                ...
                'deliveryDate':{$gte:new Date().getTime(),$lte:new Date().getTime()+24*3600*1000*10}
            };
